...
from default.adapters.services.phishing.impl import DefaultPhishingService
...
class GlobalTestCase(TestCase):
    ...
    """
    def setUp(self):
        self._impl = DefaultPhishingService()

    def tearDown(self):
        pass


class TestDefaultPhishingImpl(GlobalTestCase):
    """
    ...
    def test_ping_url(self):
        """
            Test ping_url
        """
        ping_response = self._impl.ping_url('http://www.example.com/phishing')
    ...
    def test_get_screenshots(self):
        ...
        """
        screenshots = self._impl.get_screenshots('http://www.example.com/phishing')
