...
"""
    Define Phishing Service abstract class
"""
...
class PhishingServiceException(Exception):
    """
        Exception that must be raised by PhishingService implementations
...
class PhishingServiceBase(object):
    """
        ...
        - post feedback: is the url is really a phishing page or not
            (for example to improve a Machine Learning system)
        - block url: a way, your way, to block/remove a phishing url
            (https://github.com/ovh/phishing-mitigation for example)
    ...
    def get_screenshots(self, url, limit=10):
        """
            ...
            (one url can have multiple screenshots)
    ...
    def is_screenshot_viewed(self, screenshot_id):
        """
            ...
            If your screenshotting API exposed this screenshot (as proof),
            it can be interesting to store if
            the screenshot have been viewed or not
