...
def get_category(category=None):
    ...
    **Example request**:
    ...
    .. sourcecode:: http
       ...
       GET /categories/Illegal HTTP/1.1
...
def update_category(category=None):
    ...
    **Example request**:
    ...
    .. sourcecode:: http
       ...
       PUT /categories/Illegal HTTP/1.1
       Content-Type: application/json
...
def delete_category(category=None):
    ...
    **Example request**:
    ...
    .. sourcecode:: http
       ...
       DELETE /categories/Illegal HTTP/1.1
...
def get_user_categories():
    ...
    **Example response**:
    ...
    """
    return CategoriesController.get_categories(user=g.user)
