...
"""
    Defined TicketSchedulingAlgorithm abstract class
"""
...
class TicketSchedulingAlgorithmBase(object):
    """
        Abstract class defining `abuse.models.Ticket` scheduling algorithm base
    """
    ...
    def count(self, **kwargs):
        """
            Returns how many `abuse.models.Ticket` are available according to scheduling algorithm
    ...
    def get_tickets(self, user=None, **kwargs):
        """
            ...
            :return: (the list of `abuse.models.Ticket` dict (model_to_dict) , number of tickets)
            :rtype: tuple
        """
        cls = self.__class__.__name__
